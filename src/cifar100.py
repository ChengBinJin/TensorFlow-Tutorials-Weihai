######################################################################################################
# Functions for donwloading the CIFAR-100 data-set from the internet and loading it into memory.
#
...
# Number of files for the trainig-set.
_num_files_train = 1

# Number of images for each batch-file in the trainig-set.
